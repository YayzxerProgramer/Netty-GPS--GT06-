...
export default function UserSettings() {
  ...
  const vehicles = [
    { icon: "truck", name: "MOSS-LOGISTICS-01", plate: "TX-990-BK", gps: "ROMP-7721-X" },
    { icon: "car", name: "EXECUTIVE-SUV-04", plate: "CA-112-YT", gps: "ROMP-4409-Z" },
    { icon: "ev", name: "EV-RAPID-COURIER", plate: "NY-776-WE", gps: "ROMP-1102-L" },
  ];
              ...
              <div className="profile-grid">
                <div className="avatar-card">
                  <div className="avatar-img-wrap">
                    <div className="avatar-img"><AvatarSVG /></div>
                ...
                <div className="profile-form">
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <input className="form-input" defaultValue="System_Admin_Alpha" />
                    </div>
                    <div className="form-group">
                      <label>EMAIL ADDRESS</label>
                      <input className="form-input" defaultValue="admin@romp-systems.com" />
                    </div>
                  </div>
                  <div className="form-group">
                    <label>RESET PASSWORD</label>
                    <div className="password-row">
                      <input className="form-input password" type="password" defaultValue="password123" />
                ...
                <div className="register-panel">
                  ...
                  <div className="register-fields">
                    <div className="form-group">
                      ...
                      <input className="reg-input" placeholder="e.g. MOSS-TRUCK-02" />
                    </div>
                    <div className="form-group">
                      ...
                      <input className="reg-input" placeholder="e.g. ABC-1234" />
                    </div>
                    <div className="form-group">
                      <label style={{ fontSize: 10, color: "var(--text3)", letterSpacing: "1.5px", fontWeight: 600, display: "block", marginBottom: 6 }}>ROMP GPS SERIAL</label>
                      <div className="reg-input-wrap">
                        <input className="reg-input" placeholder="Serial Key" style={{ paddingRight: 44 }} />
                        <button className="qr-btn"><Icon type="qr" size={14} /></button>
                      </div>
                    </div>
                    <button className="validate-btn">VALIDATE &amp; REGISTER</button>
                  </div>
                </div>
              </div>
            </div>
